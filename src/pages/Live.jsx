...
export default function Live() {
    ...
    useEffect(() => {
        ...
        // Prevent re-processing if already complete or in progress
        if (lotProgress[expandedLot] === 100 || (lotProgress[expandedLot] > 0 && lotProgress[expandedLot] < 100)) return;
            ...
            try {
                ...
                for (const fileName of filesInLot) {
                    ...
                    if (zipFile) {
                        ...
                        const pts = extractPointsFromCSV(pResults.data, zipEntryName);
                        ...
                        batchStats[statsKey] = {
                            length: totalDist,
                            points: pts.length,
                            hasJointBox: pts.hasJointBox === true,
                            date: 'Lot Bundle'
                        };
                    }
                    count++;
                                                    ...
                                                    <div className="flex items-center gap-3 min-w-0">
                                                        ...
                                                        <div className="min-w-0">
                                                            ...
                                                            <div className="flex items-center gap-2 mt-0.5">
                                                                ...
                                                                {fileStats[`${lot.id}_${file}`] && fileStats[`${lot.id}_${file}`].hasJointBox === false && (
                                                                    <span className="inline-flex items-center gap-1.5 px-1.5 py-0.5 bg-amber-50 text-amber-500 border border-amber-100 rounded text-[7px] font-black uppercase tracking-widest" title="JOINT BOX column missing in this report">
